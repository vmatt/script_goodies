    ...
    for i,table in enumerate(df):
        ...
        try:
            if table.columns.values[1] == "Forgalom típusa":
                ...
                table["Note"] =  table["Közlemény"].map(str) + " Bank ID: " + table["Banki tranzakció azonosító"].map(str) + " Ellenoldali számlaszám: " + table["Ellenoldali számlaszám"].map(str)
                ...
                csv_name = file_name.split('.')[0]+"_"+now_date+".csv"
